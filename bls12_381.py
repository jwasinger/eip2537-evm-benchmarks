...
class G1ProjPoint:
    ...
    def neg(self):
        return G1ProjPoint(self.x, fq_sub(0, self.y), self.z)
...
class G2ProjPoint:
    ...
    def neg(self):
        neg_y = fq2_sub((0, 0), self.y) 
        return G2ProjPoint(self.x[0], self.x[1], neg_y[0], neg_y[1], self.z[0], self.z[1])
...
g1_gen_x = to_mont(3685416753713387016781088315183077757961620795782546409894578378688607592378376318836054947676345821548104185464507)
g1_gen_y = to_mont(1339506544944476473020471379941921221584933875938349620426543736416511423956333506472724655353366534992391756441569)
g1_gen_point = G1ProjPoint(g1_gen_x, g1_gen_y, to_mont(1))
g1_gen_point_affine = G1AffinePoint(g1_gen_x, g1_gen_y)

g2_gen_x_0 = to_mont(352701069587466618187139116011060144890029952792775240219908644239793785735715026873347600343865175952761926303160)
g2_gen_x_1 = to_mont(3059144344244213709971259814753781636986470325476647558659373206291635324768958432433509563104347017837885763365758)
g2_gen_y_0 = to_mont(1985150602287291935568054521177171638300868978215655730859378665066344726373823718423869104263333984641494340347905)
g2_gen_y_1 = to_mont(927553665492332455747201965776037880757740193453592970025027978793976877002675564980949289727957565575433344219582)
g2_gen_z_0 = to_mont(1)
g2_gen_z_1 = 0
...
def g2_gen_affine():
    return g2_gen_point_affine.clone()

def g1_gen_affine():
    return g1_gen_point_affine.clone()
